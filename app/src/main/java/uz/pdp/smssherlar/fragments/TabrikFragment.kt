...
class TabrikFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        databaseReference = firebaseDatabase.getReference("all/tabrik")
        databaseReference.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                root.linear_back_tabrik.setOnClickListener {
                    fragmentManager?.beginTransaction()
                        ?.replace(R.id.container, TabrikCategoryFragment())
                        ?.addToBackStack(TabrikCategoryFragment.toString())
                        ?.commit()
                }
                root.tabrik_rv.adapter = PoemAdapter(list, object : PoemAdapter.OnClickListener {
