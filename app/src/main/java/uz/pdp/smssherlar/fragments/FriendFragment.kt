...
class FriendFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        databaseReference = firebaseDatabase.getReference("all/friend")
        databaseReference.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                root.linear_back_friend.setOnClickListener {
                    fragmentManager?.beginTransaction()
                        ?.replace(R.id.container, HomeFragment())
                        ?.addToBackStack(HomeFragment.toString())
                        ?.commit()
                }
                root.friend_rv.adapter = PoemAdapter(list, object : PoemAdapter.OnClickListener {
